...
// chaining promises to call postData & updateUI functions-- advice by the reviewer
   getWeatherInfo(baseURL, zip, apiKey).then((data)=>{
...
const getWeatherInfo= async (baseURL, zip, apiKey) =>{
  // set a variable for APIurl to make it much easier in fetch function
  const apiURL= baseURL+zip+apiKey;
  // fetch API url that contains the information
