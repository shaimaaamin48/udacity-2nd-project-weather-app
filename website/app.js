...
let zipCode= document.getElementById('zip');// I've removed .valur from it as the instructor said in the 2 nd webinar
...
function actionTaken(e){
// asynchronous fetch API callback function with the three arguments (baseurl, zipcode,APIkey)
  getZipCode(baseURL, zipCode.value, apiKEY);//  here i added the value to be get from zipCode element.
};

// the 2nd callback function "getZipCode"
const getZipCode= async (baseURL, zipCode.value, apiKEY) =>{
    // fetch API info
